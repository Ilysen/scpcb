...
;			EntityParent dp\cam,fr\Forest_Pivot
		...
		Case "room2testroom2"
			...
			it = CreateItem("Level 2 Keycard", "key2", r\x - 914.0 * RoomScale, r\y + 137.0 * RoomScale, r\z + 61.0 * RoomScale)
			EntityParent(it\collider, r\obj)
		...
		Case "room2storage"
			...
			it = CreateItem("Level 1 Keycard", "key1", r\x - 672.0 * RoomScale, r\y + 240.0 * RoomScale, r\z + 224.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			;[End Block]
		Case "room2sroom"
			;[Block]
			...
			it = CreateItem("Level 5 Keycard", "key5", r\x + 2232.0 * RoomScale, r\y + 392.0 * RoomScale, r\z + 387.0 * RoomScale)
		...
		Case "room2shaft"
			...
			it = CreateItem("Level 3 Keycard", "key3", r\x + 1119.0 * RoomScale, r\y + 233.0 * RoomScale, r\z + 494.0 * RoomScale)
			EntityParent(it\collider, r\obj)
...
;			
		...
		Case "room049"
			...
			it = CreateItem("Level 4 Keycard", "key4", r\x - 512.0 * RoomScale, r\y - 3412.0 * RoomScale, r\z + 864.0 * RoomScale)
			EntityParent(it\collider, r\obj)
...
;			PositionEntity(r\Objects[6], r\x - 848*RoomScale, 0.5, r\z-576*RoomScale, True)
		...
		Case "room2closets"
			...
			it = CreateItem("Level 1 Keycard", "key1", r\x + 736.0 * RoomScale, r\y + 240.0 * RoomScale, r\z + 752.0 * RoomScale)
			EntityParent(it\collider, r\obj)
		...
		Case "room2offices"
			...
			it = CreateItem("Level 2 Keycard", "key2", r\x - 156.0 * RoomScale, r\y + 151.0 * RoomScale, r\z + 72.0 * RoomScale)
			EntityParent(it\collider, r\obj)
		...
		Case "room2offices2"
			;[Block]
			it = CreateItem("Level 1 Keycard", "key1", r\x - 368.0 * RoomScale, r\y - 48.0 * RoomScale, r\z + 80.0 * RoomScale)
			EntityParent(it\collider, r\obj)
		...
		Case "coffin"
			...
			it = CreateItem("Level 3 Keycard", "key3", r\x + 240.0 * RoomScale, r\y -1456.0 * RoomScale, r\z + 2064.0 * RoomScale)
			EntityParent(it\collider, r\obj)
		...
		Case "room106"
			;[Block]
			it = CreateItem("Level 5 Keycard", "key5", r\x - 752.0 * RoomScale, r\y - 592 * RoomScale, r\z + 3026.0 * RoomScale)
			EntityParent(it\collider, r\obj)
